...
//                 (selectedItem === item.id && item.id !== "pages") ||
//                 (item.id === "pages" && isPagesOpen)
...
//                   setSelectedItem(""); // Unselect other items
//                 } else {
//                   setSelectedItem(item.id);
//                   setIsPagesOpen(false); // Close PAGES dropdown
//                 }
//               }}
//             >
...
//                 <div
//                   ref={pagesRef}
//                   className="absolute top-6  mt-6 left-0 text-white p-3 rounded-lg shadow-lg w-32 bg-gray-900"
//                 >
