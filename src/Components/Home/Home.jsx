    ...
    <div className='mt-0 m-auto  border-l border-r border-gray-800'>
      ...
      <div className={`${window.innerWidth <= 768 ? 'flex justify-center items-center': 'ml-8 flex '}`} >
            <div className={`${window.innerWidth <= 768 
                  ? 'flex justify-center items-center text-center w-[300px] h-19 border-r-8 border-l-8 rounded-bl-[2rem] rounded-br-[2rem] font-bold bg-green-600 shadow-2xl mb-[2em] px-2 border-green-100 relative z-10 '
