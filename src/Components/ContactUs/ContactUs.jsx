               ...
               <form onSubmit={handleSubmit} className={`${window.innerWidth < 768 ? 'w-100 flex flex-col justify-center items-center':'space-y-4 w-100'}`}>
                    <div>
                        ...
                        <input
                            ...
                            className={`${window.innerWidth <= 768 ? 'mt-1 block hover:text-black hover:bg-green-600 w-full max-w-xs  p-2  hover:border-black border border-gray-300 rounded-md':'mt-1 block hover:text-black hover:bg-green-600 w-full p-2  hover:border-black border border-gray-300 rounded-md'}`}
